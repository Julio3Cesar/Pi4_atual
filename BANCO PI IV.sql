...
INSERT INTO PRODUTO VALUES ('asasas234a','MODELO TESTE 1','PRETO','100','10','1','1','1')
...
, sum (A.PRECO_FINAL) AS [TOTAL R$ NO PERÍODO]
FROM
VENDA A 
INNER JOIN 
ITENS_VENDA B 
...
, COUNT (CASE WHEN PARCELAS = 1 THEN 1 ELSE NULL END) AS 'A VISTA'
