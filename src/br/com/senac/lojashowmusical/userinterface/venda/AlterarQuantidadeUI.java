 ...
 * @author bob-c
 */
public class AlterarQuantidadeUI extends javax.swing.JDialog {

    private Integer qtd;

    /**
     * Creates new form AlterarQuantidadeUI
     */
    public AlterarQuantidadeUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarQuantidadeUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlterarQuantidadeUI dialog = new AlterarQuantidadeUI(new javax.swing.JFrame(), true);
